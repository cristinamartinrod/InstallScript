...
ADMIN_EMAIL="crisrina.marrod@gmail.com.com"
##
...
if [ $IS_ENTERPRISE = "True" ]; then
    ...
    GITHUB_RESPONSE=$(sudo git clone --depth 1 --branch $OE_VERSION https://www.github.com/cristinamartinrod/enterprise "$OE_HOME/enterprise/addons" 2>&1)
    ...
    udo apt install python3-testresources
